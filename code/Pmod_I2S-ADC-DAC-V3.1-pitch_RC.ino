...
//---DEBUG-BLINK---
// an LED at this port will show some timing
//#define LED1 32     
//#define LED2 33
...
//Display Pitch
  ...
  display.fillRect(0, 27, valu0  , 4);                  // (x, y, width, height)
  display.drawVerticalLine(valu[0], 26, 6);             // (x, y, width)
...
size_t readsize = 0; 
    ...
    if (err == ESP_OK && readsize==queue*4) {
          ...
          // Store the last sample from the 4 DMA queues
